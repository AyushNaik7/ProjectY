...
const features = [
  {
    ...
    description: 'Get matched with perfect brand and creator partners instantly.'
  },
  {
    icon: TrendingUp,
    title: 'Grow Your Network',
    description: 'Access exclusive collaboration opportunities and expand your reach.'
  },
  {
    icon: Users,
    title: 'Verified Community',
    description: 'Connect only with verified, professional creators and brands.'
  }
];
        ...
        >
          <div>
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
              Start <span className="text-blue-400">collaborating</span> today.
            </h1>
            <p className="text-lg text-slate-300">
              Join the fastest-growing creator and brand matching platform. Find your perfect partner and build something amazing.
            </p>
          </div>
      ...
      <div className="w-full lg:w-1/2 bg-white flex items-center justify-center p-6 sm:p-12 overflow-y-auto">
        ...
        >
          <div className="mb-8">
            ...
            <p className="text-slate-600">Join Collabo and start collaborating</p>
          </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`py-3 px-4 rounded-lg font-medium transition duration-200 border-2 ${
