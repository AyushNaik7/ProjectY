-- ============================================================
-- FINAL MIGRATION - Works with TEXT IDs
-- This version assumes brands.id and creators.id are TEXT type
-- ============================================================
...
DROP FUNCTION IF EXISTS recalculate_rating(TEXT, TEXT) CASCADE;
...
-- ============================================================
-- Migration 014: Conversations & Messages (TEXT IDs)
-- ============================================================

-- Add clerk_user_id columns
...
-- ============================================================
-- Migration 016: Creator Portfolio (TEXT IDs)
-- ============================================================
...
-- ============================================================
-- Migration 017: Reviews & Ratings (TEXT IDs)
-- ============================================================
...
-- ============================================================
-- Migration 018: Escrow Payments (TEXT IDs)
-- ============================================================

CREATE TABLE payments (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  collaboration_request_id TEXT NOT NULL UNIQUE,
...
BEGIN
  ...
  RAISE NOTICE '- conversations (TEXT IDs)';
  RAISE NOTICE '- messages';
  RAISE NOTICE '- notifications';
  RAISE NOTICE '- portfolio_items (TEXT IDs)';
  RAISE NOTICE '- profile_views (TEXT IDs)';
  RAISE NOTICE '- reviews (TEXT IDs)';
  RAISE NOTICE '- payments (TEXT IDs)';
  RAISE NOTICE '';
  RAISE NOTICE 'Next steps:';
  RAISE NOTICE '1. Create storage buckets';
  RAISE NOTICE '2. Update clerk_user_id for users';
